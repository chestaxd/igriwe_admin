...
(function($, undefined) {
  ...
  /**
   ...
   options: {
      ...
      menuHeight: 400,                    // (integer | string | 'auto' | 'size') Sets the height of the menu or determines it using native select's size setting.
      ...
      groupColumns: true                 // (true | false)  Displays groups in a horizonal column layout.
    },
